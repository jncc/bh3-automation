DROP FUNCTION IF EXISTS public.bh3_safe_difference(geometry, geometry, double precision);
...
DROP FUNCTION IF EXISTS public.bh3_safe_union(geometry, double precision);

CREATE OR REPLACE FUNCTION public.bh3_safe_union_transfn(agg_state geometry, el geometry)
RETURNS geometry
IMMUTABLE
LANGUAGE plpgsql
AS $BODY$
...
DROP FUNCTION IF EXISTS public.bh3_create_csquares(integer, boolean, name, name, boolean, numeric, integer);
...
DROP FUNCTION IF EXISTS public.bh3_disturbance_map(integer, timestamp without time zone, name, name, name, name, name, name, name, name, name, boolean, timestamp without time zone, integer);
...
DROP FUNCTION IF EXISTS public.bh3_get_pressure_csquares(integer, name, timestamp without time zone, timestamp without time zone, name, name, name, name, boolean, integer);
...
DROP FUNCTION IF EXISTS public.bh3_habitat_boundary_clip(integer, character varying[], name, name, name, name, name, name, name, name, boolean, boolean, boolean, boolean);
...
DROP FUNCTION IF EXISTS public.bh3_habitat_grid(integer, name, name, name, name, name, name, boolean, numeric);
...
DROP FUNCTION IF EXISTS public.bh3_sensitivity_layer_prep(name, name, integer, sensitivity_source, timestamp without time zone, timestamp without time zone, character varying[], name, name, name, name, name, name, boolean, boolean, integer);
...
DROP FUNCTION IF EXISTS public.bh3_species_sensitivity_clipped(name, name, integer, sensitivity_source, timestamp without time zone, character varying[], timestamp without time zone, boolean, boolean, integer);
...
DROP PROCEDURE IF EXISTS public.bh3_procedure(integer, character varying[], timestamp without time zone, sensitivity_source, name, name, name, name, name, name, name, name, name, name, name, name, name, name, name, name, timestamp without time zone, boolean, boolean, boolean, integer);
