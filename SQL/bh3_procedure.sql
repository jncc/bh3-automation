-- PROCEDURE: public.bh3_procedure(integer, character varying[], timestamp without time zone, sensitivity_source, name, name, name, name, name, name, name, name, name, name, name, name, name, name, name, name, timestamp without time zone, boolean, boolean, boolean, numeric, integer)

-- DROP PROCEDURE public.bh3_procedure(integer, character varying[], timestamp without time zone, sensitivity_source, name, name, name, name, name, name, name, name, name, name, name, name, name, name, name, name, timestamp without time zone, boolean, boolean, boolean, numeric, integer);
...
cell_size_degrees					c-square grid cell size (must match size of pressure source tables)
